# 🕷️ AGENT HANDOFF: Recovery-Tree → Spidersan
...
|------|-------|--------------|
| `scripts/spider-cli.js` | 760 | Full CLI with 13 commands |
...
**Commands that exist:**
- `list`, `register`, `depends`, `conflicts`, `update-conflicts`
- `merge-order`, `ready-check`, `stale`, `cleanup`, `sync`
- `abandon`, `merged`, `help`
...
2. **Extract and adapt `spider-cli.js`**
...
| File | Purpose |
|------|---------|
| `DATA_COLLECTION.md` | What code exists, gap analysis |
| `implementation_plan.md` | Technical build plan |
| `ONE_PAGER.md` | Product summary, pricing |
| `LICENSE.md` | Open Core + BSL dual license |
| `README.md` | GitHub readme draft |
...
- `/scripts/spider-cli.js` - The main CLI
- `/.spidersan.config.json` - Config structure
- `/SPIDERSAN_GUIDE.md` - Branch hygiene rules
- `/SANCHO_BRIEFING_Spidersan_Safeguards_11-12-25.md` - Recent implementation notes
...
4. [ ] Port `spider-cli.js` logic to TypeScript
