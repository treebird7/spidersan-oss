...
export const doctorCommand = new Command('doctor')
    ...
    .action(async (options) => {
        if (options.remote) {
            ...
            // Performance Optimization: Consolidate multiple .filter().length calls into a single pass
            // to avoid redundant O(N) traversals and intermediate array allocations
        ...
        // Performance Optimization: Consolidate filter calls to avoid redundant array allocations
