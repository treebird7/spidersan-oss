...
export const doctorCommand = new Command('doctor')
    ...
    .action(async (options) => {
        if (options.remote) {
            ...
            // ⚡ Bolt: Performance optimization - replace multiple O(N) array filters with a single O(N) loop
        ...
        // ⚡ Bolt: Performance optimization - single loop for rendering and counting
