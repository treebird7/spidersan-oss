...
function runEcosystemScan(repos: string[], asJson: boolean): void {
    ...
    // Performance Optimization: Calculate totals and conflict presence in a single pass
    // instead of .reduce() and .filter().length to avoid redundant object/array allocations
