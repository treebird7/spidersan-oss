...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        ...
        // ⚡ Bolt: Single-pass counting to avoid multiple redundant O(N) .filter().length array traversals
        let completed = 0;
        let active = 0;
        ...
        let rootChildrenZero = 0;
        for (const r of roots) {
            if (r.children.length === 0) rootChildrenZero++;
        }

        const parents = roots.length;
        const children = total - rootChildrenZero;
