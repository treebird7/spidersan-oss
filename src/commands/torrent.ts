...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        ...
        // Optimization: Avoid redundant array allocations and O(N) traversals
        let rootsWithNoChildren = 0;
        for (const r of roots) {
            if (r.children.length === 0) rootsWithNoChildren++;
        }
        const children = total - rootsWithNoChildren;
