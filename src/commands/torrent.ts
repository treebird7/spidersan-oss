...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        ...
        // Performance Optimization: Calculate completed/active counts in a single pass to avoid O(N) allocations
        ...
        for (const r of roots) {
            if (r.children.length === 0) noChildrenCount++;
        }
        const children = total - noChildrenCount;
