...
export const COMMANDS: CommandEntry[] = [
    ...
    { name: 'depends', description: 'Set or show dependencies for a branch (deps merge first)', load: async p => p.addCommand((await import('../commands/depends.js')).dependsCommand) },
    ...
    { name: 'claim', description: '🕷️ Claim file(s) on the current branch for an agent', load: async p => p.addCommand((await import('../commands/coord.js')).claimCommand) },
    { name: 'release', description: '🕷️ Release file(s) you previously claimed', load: async p => p.addCommand((await import('../commands/coord.js')).releaseCommand) },
    { name: 'whos-here', description: "🕷️ Show who's actively claimed which files on the current branch", load: async p => p.addCommand((await import('../commands/coord.js')).whosHereCommand) },
